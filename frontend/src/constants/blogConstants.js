...
export const BLOG_CREATE_DETAILS_REQUEST = 'BLOG_CREATE_DETAILS_REQUEST'
export const BLOG_CREATE_DETAILS_SUCCESS = 'BLOG_CREATE_DETAILS_SUCCESS'
export const BLOG_CREATE_DETAILS_FAIL = 'BLOG_CREATE_DETAILS_FAIL'
export const BLOG_CREATE_DETAILS_RESET = 'BLOG_CREATE_DETAILS_RESET'
