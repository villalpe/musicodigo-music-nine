...
export const blogDetailCreateReducer = (state = {}, action) => {
    switch (action.type) {
        case BLOG_CREATE_DETAILS_REQUEST:
            return { loading: true }

        case BLOG_CREATE_DETAILS_SUCCESS:
            return { loading: false, success: true }

        case BLOG_CREATE_DETAILS_FAIL:
            return { loading: false, error: action.payload }

        case BLOG_CREATE_DETAILS_RESET:
                return {}            
        default:
            return state
    }
